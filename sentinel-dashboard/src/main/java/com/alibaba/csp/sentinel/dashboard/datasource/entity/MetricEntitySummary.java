 ...
 * @author jiudd
 */
public class MetricEntitySummary {
    ...
    public static MetricEntitySummary copyOf(MetricEntitySummary oldEntity) {
        MetricEntitySummary entity = new MetricEntitySummary();
